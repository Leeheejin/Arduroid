...
Blockly.Msg.MATH_RANDOM_INT_TITLE = "랜덤한 숫자 (%1<= n <=%2)";
...
Blockly.Msg.VARIABLES_SET = "%1 를 다음 값으로 바꾸기 %2";
...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "아날로그 핀";  // @Arduroid
Blockly.Msg.ARD_ANALOGREAD_TIP = "센서의 값을 0 에서 1024 사이의 수로 표시합니다.";  // @Arduroid
Blockly.Msg.ARD_ANALOGWRITE = "아날로그 핀";  // @Arduroid
Blockly.Msg.ARD_ANALOGWRITE_TIP = "아날로그 핀의 값을 읽어 0 에서 255 사이의 수로 표시합니다.";  // @Arduroid
Blockly.Msg.ARD_BUILTIN_LED = "내장 LED";  // @Arduroid
Blockly.Msg.ARD_BUILTIN_LED_TIP = "아두이노 내장 LED를 켜거나 끕니다.";  // @Arduroid
Blockly.Msg.ARD_COMPONENT_WARN1 = "이 %1 설정은 %2의 이름을 가진 블럭을 반드시 먼저 추가해야 합니다.";  // @Arduroid
Blockly.Msg.ARD_DEFINE = "Define";  // untranslated
Blockly.Msg.ARD_DIGITALREAD = "디지털 핀";  // untranslated
Blockly.Msg.ARD_DIGITALREAD_TIP = "디지털 핀의 값을 읽어옵니다. HIGH 또는 LOW로 표시합니다.";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE = "디지털 핀";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Write digital value HIGH or LOW to a specific Port";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "반복해서 실행하기";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "가장 처음 한 번만";  // untranslated
Blockly.Msg.ARD_FUN_RUN_TIP = "아두이노의 처음 시작 부분 setup() 과 반복할 부분 loop()를 정의합니다.";  // untranslated
...
Blockly.Msg.ARD_MAP = "";  // untranslated
Blockly.Msg.ARD_MAP_TIP = "[0 ~1024]의 수를 다른 수로 매핑합니다.";  // untranslated
Blockly.Msg.ARD_MAP_VAL = "을(를) 0부터 ";  // untranslated
Blockly.Msg.ARD_MAP_VAL_1 = "까지의 숫자로 매핑하기";  // @Arduroid
Blockly.Msg.ARD_NOTONE = "핀";  // untranslated
Blockly.Msg.ARD_NOTONE_1 = "의 소리를 끄기";  // untranslated
...
Blockly.Msg.ARD_NOTONE_TIP = "선택된 핀의 소리를 끕니다.";  // untranslated
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 is needed for %2 as pin %3. Already used as %4.";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "정해진 핀의 진동 주기를 측정한다. 정해진 시간이 지나면 시간제한 초과";  // @Arduroid
Blockly.Msg.ARD_PULSE_READ = "핀%2 의 진동이 %1 가 되기 까지의 길이재기";  // @Arduroid
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "핀%2 의 진동이 %1 가 되기 까지의 길이재기 ( %3 μs초 동안)";  // @Arduroid
Blockly.Msg.ARD_PULSE_TIP = "정해진 핀의 진동 주기를 측정한다.";  // @Arduroid
Blockly.Msg.ARD_SERIAL_BPS = "bps로 설정하기";  //@Arduroid
Blockly.Msg.ARD_SERIAL_PRINT = "통신 화면에 ";  //@Arduroid
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "를 쓰기 [체크하면 한 줄 띄움]";  //@Arduroid
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "콘솔이나 시리얼 포트에 사람이 읽을 수 있는 ASCII 텍스트를 출력합니다.";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "이 블록을 사용하려면 반드시 %1 통신을 먼저 설정해야합니다.";  //@Arduroid
Blockly.Msg.ARD_SERIAL_SETUP = "이";  //@Arduroid
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Selects the speed for a specific Serial peripheral";  // untranslated
Blockly.Msg.ARD_SERIAL_SPEED = "통신의 속도를";  //@Arduroid
Blockly.Msg.ARD_SERVO_READ = "핀";  //@Arduroid
Blockly.Msg.ARD_SERVO_READ1 = "의 서보모터 각도를 받아오기";  //@Arduroid
Blockly.Msg.ARD_SERVO_READ_TIP = "현재 서보모터의 각도를 받아옵니다.";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE = "핀";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "º로 바꾸기 (0º~180º)";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TIP = "서보모터의 각도를 바꿉니다.";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TO = "의 서보모터의 각도를";  // untranslated
Blockly.Msg.ARD_SETTONE = "핀";  // untranslated
Blockly.Msg.ARD_SPI_SETUP = "";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_CONF = "통신 설정: ";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "clock divide";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPI 모드 (idle - edge)";  // untranslated
...
Blockly.Msg.ARD_STEPPER_MOTOR = "를 설정하기";  // untranslated
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "핀 번호";  // @Arduroid
Blockly.Msg.ARD_STEPPER_PIN1 = "핀 1#";  // @Arduroid
Blockly.Msg.ARD_STEPPER_PIN2 = "핀 2#";  // @Arduroid
Blockly.Msg.ARD_STEPPER_PIN3 = "핀 3#";  // @Arduroid
Blockly.Msg.ARD_STEPPER_PIN4 = "핀 4#";   // @Arduroid
Blockly.Msg.ARD_STEPPER_REVOLVS = "움직일 스텝 수는 ";  // @Arduroid
Blockly.Msg.ARD_STEPPER_SETUP = "스텝퍼 모터 ";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configures a stepper motor pinout and other settings.";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "속도(rpm)는 ";  // @Arduroid
Blockly.Msg.ARD_STEPPER_STEP = "스텝퍼 모터 "; // @Arduroid
Blockly.Msg.ARD_STEPPER_STEP1 = "를 "; // @Arduroid
Blockly.Msg.ARD_STEPPER_STEPS = "스텝만큼 움직이기";  // untranslated
...
Blockly.Msg.ARD_TIME_DELAY = "";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICROS = "μs 기다리기";  // @Arduroid
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "정해진 시간(백만분의 1초) 만큼 기다립니다.";   // @Arduroid
Blockly.Msg.ARD_TIME_DELAY_TIP = "정해진 시간(1000분의 1초) 만큼 기다립니다.";   // @Arduroid
Blockly.Msg.ARD_TIME_DELAY_SEC_TIP = "정해진 시간(초) 만큼 기다립니다.";  // @Arduroid
Blockly.Msg.ARD_TIME_DELAY_SEC = "초 기다리기";  // @Arduroid
Blockly.Msg.ARD_TIME_INF = "영원히 기다리기 (프로그램 종료)";   // @Arduroid
Blockly.Msg.ARD_TIME_INF_TIP = "영원히 기다립니다. 프로그램을 종료합니다.";   // @Arduroid
Blockly.Msg.ARD_TIME_MICROS = "현재시간 기록(마이크로초)";   // @Arduroid
Blockly.Msg.ARD_TIME_MICROS_TIP = "현재 프로그램이 구동된 시간을 마이크로초 단위로 반환합니다. 양수인 long 정수형으로 저장합니다.";   // @Arduroid
Blockly.Msg.ARD_TIME_MILLIS = "현재시간 기록(ms)";   // @Arduroid
Blockly.Msg.ARD_TIME_MILLIS_TIP = "현재 프로그램이 구동된 시간을 밀리초 단위로 반환합니다. 양수인 long 정수형으로 저장합니다.";   // @Arduroid
Blockly.Msg.ARD_TIME_MS = "ms 기다리기";  // @Arduroid
Blockly.Msg.ARD_TONEFREQ = "의 주파수를";   // @Arduroid
Blockly.Msg.ARD_TONEFREQ_1 = "로 바꾸기";   // @Arduroid
Blockly.Msg.ARD_TONE_FREQ = "주파수";  // @Arduroid
Blockly.Msg.ARD_TONE_PIN = "Tone PIN#";  // untranslated
Blockly.Msg.ARD_TONE_PIN_TIP = "Generate audio tones on a pin";  // untranslated
Blockly.Msg.ARD_TONE_TIP = "핀의 주파수를 31 - 65535 사이로 변경합니다.";   // @Arduroid
Blockly.Msg.ARD_TONE_WARNING = "주파수는 반드시 31 - 65535 사이여야 합니다.";   // @Arduroid
Blockly.Msg.ARD_TYPE_ARRAY = "배열"; // @Arduroid
Blockly.Msg.ARD_TYPE_BOOL = "참/거짓";  // @Arduroid
Blockly.Msg.ARD_TYPE_CHAR = "문자형";  // @Arduroid
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "10진수"; // @Arduroid
Blockly.Msg.ARD_TYPE_LONG = "숫자 Long";  // @Arduroid
Blockly.Msg.ARD_TYPE_NULL = "Null";   // @Arduroid
Blockly.Msg.ARD_TYPE_NUMBER = "정수";   // @Arduroid
Blockly.Msg.ARD_TYPE_SHORT = "숫자 Short";   // @Arduroid
Blockly.Msg.ARD_TYPE_TEXT = "텍스트";  // @Arduroid
Blockly.Msg.ARD_TYPE_UNDEF = "정의되지 않음";   // @Arduroid
Blockly.Msg.ARD_VAR_AS_1 = "을(를)";  // @Arduroid
Blockly.Msg.ARD_VAR_AS_2 = "으로";  // @Arduroid
Blockly.Msg.ARD_VAR_AS = "as";  // untranslated
Blockly.Msg.ARD_VAR_AS_TIP = "값을 다른 자료형으로 바꿉니다.";   // @Arduroid
Blockly.Msg.ARD_WRITE_TO = "을(를)";  // @Arduroid
Blockly.Msg.NEW_INSTANCE = "새로운 객체...";   // @Arduroid
Blockly.Msg.NEW_INSTANCE_TITLE = "새로운 객체 이름:";   // @Arduroid
Blockly.Msg.RENAME_INSTANCE = "이름 바꾸기";  // @Arduroid
Blockly.Msg.RENAME_INSTANCE_TITLE = "Rename all '%1' instances to:";  // untranslated
Blockly.Msg.ARD_WRITE_DO_1 = "의 값";  // @Arduroid

Blockly.Msg.ARD_BLUETOOTH_SERIAL1 = "블루투스";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_SERIAL2= "을(를) RX 핀";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_SERIAL3 = "TX 핀";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_SERIAL4 = "로 시작하기";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_SERIAL_TIP = "RX핀 과 TX핀을 지정하여 블루투스 통신을 설정합니다.";   // @Arduroid

Blockly.Msg.ARD_BLUETOOTH_BEGIN = "이 블루투스";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_BEGIN1 = "의 통신 속도를";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_BEGIN2 = "으로 다시 시작하기";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_BEGIN_TIP = "블루투스의 통신을 정한 값으로 다시 시작합니다.";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_THIS = "";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_AVAILABLE = "에 입력받기";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_READ = "의 값을 받아오기";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_WRITE = "에";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_WRITE1 = "보내기";   // @Arduroid
Blockly.Msg.ARD_BLUETOOTH_END = "의 통신을 끝내기";   // @Arduroid
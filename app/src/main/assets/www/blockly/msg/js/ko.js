...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "아날로그 핀";  // untranslated
Blockly.Msg.ARD_ANALOGREAD_TIP = "센서의 값을 0 에서 1024 사이의 수로 표시합니다.";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE = "아날로그 핀";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE_TIP = "아날로그 핀의 값을 읽어 0 에서 255 사이의 수로 표시합니다.";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED = "내장 LED";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED_TIP = "아두이노 내장 LED를 켜거나 끕니다.";  // untranslated
...
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "정해진 시간(백만분의 1초) 만큼 기다립니다.";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_TIP = "정해진 시간(1000분의 1초) 만큼 기다립니다.";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_SEC_TIP = "정해진 시간(초) 만큼 기다립니다.";  // @Arduroid
Blockly.Msg.ARD_TIME_DELAY_SEC = "초 기다리기";  // @Arduroid
Blockly.Msg.ARD_TIME_INF = "영원히 기다리기 (프로그램 종료)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "영원히 기다립니다. 프로그램을 종료합니다.";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "현재시간 기록(마이크로초)";  // untranslated
Blockly.Msg.ARD_TIME_MICROS_TIP = "현재 프로그램이 구동된 시간을 마이크로초 단위로 반환합니다. 양수인 long 정수형으로 저장합니다.";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS = "현재시간 기록(ms)";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS_TIP = "현재 프로그램이 구동된 시간을 밀리초 단위로 반환합니다. 양수인 long 정수형으로 저장합니다.";  // untranslated
Blockly.Msg.ARD_TIME_MS = "ms 기다리기";  // untranslated
Blockly.Msg.ARD_TONEFREQ = "의 주파수를";  // untranslated
Blockly.Msg.ARD_TONEFREQ_1 = "로 바꾸기";  // untranslated
...
Blockly.Msg.ARD_TONE_TIP = "핀의 주파수를 31 - 65535 사이로 변경합니다.";  // untranslated
Blockly.Msg.ARD_TONE_WARNING = "Frequency must be in range 31 - 65535";  // untranslated
Blockly.Msg.ARD_TYPE_ARRAY = "배열";  // untranslated
Blockly.Msg.ARD_TYPE_BOOL = "참/거짓";  // untranslated
Blockly.Msg.ARD_TYPE_CHAR = "문자형";  // untranslated
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "10진수";  // untranslated
Blockly.Msg.ARD_TYPE_LONG = "숫자 Long";  // untranslated
Blockly.Msg.ARD_TYPE_NULL = "Null";  // untranslated
Blockly.Msg.ARD_TYPE_NUMBER = "정수";  // untranslated
Blockly.Msg.ARD_TYPE_SHORT = "숫자 Short";  // untranslated
Blockly.Msg.ARD_TYPE_TEXT = "텍스트";  // untranslated
Blockly.Msg.ARD_TYPE_UNDEF = "정의되지않음";  // untranslated
Blockly.Msg.ARD_VAR_AS_1 = "을(를)";  // @Arduroid
Blockly.Msg.ARD_VAR_AS_2 = "으로";  // @Arduroid
Blockly.Msg.ARD_VAR_AS = "as";  // untranslated
Blockly.Msg.ARD_VAR_AS_TIP = "값을 다른 자료형으로 바꿉니다.";  // untranslated
Blockly.Msg.ARD_WRITE_TO = "을(를)";  // untranslated

        ...
        public SerialCommunicator getSerialCommunicator(Context context) {
                ...
                if(USE_USB) {
                        ...
                        for(UsbDevice device : usbAccess.manager().getDeviceList().values()) {
                                ...
                                Log.v("value", "This part vid"+vid );
                                Log.v("value", "This part pid"+pid );
                                int foo = 0;
                                for(UsbVidList usbVid : UsbVidList.values()) {
                                        foo ++;
                                        Log.v("arduroid", "This part foo .... "+foo );
                                        Log.v("arduroid", "This part getVid .... "+usbVid.getVid() );
                        ...
                        if(sc == null) {
                                ...
                                Log.v("value", "This part context " +context);

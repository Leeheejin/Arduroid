...
public class Physicaloid {
        ...
        public boolean open(UartConfig uart) throws RuntimeException {
                synchronized(LOCK) {
                        if(mSerial == null) {
                                ...
                                if(mSerial == null) {
                                        Log.v("value", "This part 555");
                                        return false;
                                }
                        }
                        if(mSerial.open()) {
                                Log.v("value", "This part 666");
        ...
        public void upload(Boards board, String filePath, UploadCallBack callback) throws RuntimeException {
                Log.v("arduroid", "upload Part Here!");
                if(filePath == null) {
                        Log.v("arduroid", "upload Part Here! but last was null");
                        if(callback != null) {
                ...
                if(!file.exists() || !file.isFile() || !file.canRead()) {
                        Log.v("arduroid", "upload Part Here! but File open error");
                        if(callback != null) {
                                callback.onError(UploadErrors.FILE_OPEN);
                        }
                        return;
                ...
                try {
                        ...
                        if(callback != null) {
                                Log.v("arduroid", "upload Part Here! but what???");
                                callback.onError(UploadErrors.FILE_OPEN);
                        }
                        return;
                }
        ...
        public void upload(Boards board, InputStream fileStream, UploadCallBack callback) throws RuntimeException {
                ...
                if(mSerial == null) { // if not open
                        if(DEBUG_SHOW) {
                                ...
                                Log.v("arduroid", "upload : mSerial is null");
                        }
